    ...
    <main className="text-center font-bold">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center bg-white p-8 text-black">
        <div className="max-w-5xl">
          <h1 className="flex flex-col text-5xl font-black leading-none md:text-7xl lg:text-8xl">
      ...
      >
        <div className="max-w-md">
          <h1 className="text-5xl font-black md:text-7xl">This is Mike.</h1>
          <Image
      ...
      <section className="flex min-h-screen flex-col items-center justify-center bg-[#dcfce7] p-8">
        <h2 className="text-5xl font-black md:text-7xl">He has Three Moods.</h2>
        <div className="mt-12 grid grid-cols-1 gap-12 md:grid-cols-3">
          <div className="flex flex-col items-center">
            <Image
              ...
              height={200}
            />
            <p className="mt-4 text-2xl md:text-3xl">Sad</p>
          </div>
          <div className="flex flex-col items-center">
            <Image
              src="/animations/cactus_medium.png"
              ...
              height={200}
            />
            <p className="mt-4 text-2xl md:text-3xl">Neutral</p>
          </div>
          <div className="flex flex-col items-center">
            <Image
              ...
              height={200}
            />
            <p className="mt-4 text-2xl md:text-3xl">Happy</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-2xl">
          ...
          {!session && (
            <div className="mt-12">
              <Link
                href="/signup"
                className="rounded-xl border-4 border-black bg-white px-12 py-5 text-xl font-bold text-black shadow-[8px_8px_0_0_#000] transition-all hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-[5px_5px_0_0_#000] active:translate-x-[8px] active:translate-y-[8px] active:shadow-none md:text-2xl"
              >
                Get Started
              </Link>
            </div>

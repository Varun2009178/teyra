            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center space-x-2">
                <Image 
                  ...
                  className="w-8 h-8"
                />
                <span className="text-xl font-black text-black tracking-tight">teyra</span>
              </Link>
            </div>
             ...
             <div className="lg:col-span-7 space-y-7 mt-0">
              ...
              >
                <h1 className="heading-xl text-gray-900">
                  ...
                  <span>
                    <ScrambleText>is</ScrambleText>
                  </span>
                  <br />
                  <span className="relative inline-block">
                    <ScrambleText>Broken</ScrambleText>
                    <motion.div 
                      className="absolute -bottom-2 left-0 w-full h-1 bg-gray-900 rounded-full"

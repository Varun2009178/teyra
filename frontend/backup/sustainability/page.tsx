            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center space-x-2">
                <Image 
                  ...
                  className="w-8 h-8"
                />
                <span className="text-xl font-bold text-black">teyra</span>
              </Link>
            </div>
              ...
              {isSignedIn ? (
                <>
                  ...
                  <UserButton 
                    ...
                    appearance={{
                      elements: {
                        avatarBox: "w-8 h-8 shadow-lg hover:shadow-xl transition-all duration-300",
            ...
            >
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Sustainable Task Recommendations</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            >
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Minimal AI Usage</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
            ...
            >
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Green Hosting</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">Sustainable Features</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            >
              <div className="md:w-1/2">
                <div className="bg-green-50 p-8 rounded-2xl">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Eco-Friendly Task Suggestions</h3>
              ...
              <div className="md:w-1/2 space-y-4">
                <div className="bg-white p-4 rounded-lg border-l-4 border-green-600">
                  <p className="font-medium">Instead of: "Buy new running shoes"</p>
                  <p className="text-green-600">Mike suggests: "Research sustainable athletic wear brands"</p>
                </div>
                <div className="bg-white p-4 rounded-lg border-l-4 border-green-600">
                  <p className="font-medium">Instead of: "Print documents"</p>
                  <p className="text-green-600">Mike suggests: "Organize digital files for easy access"</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="md:w-1/2">
                <div className="bg-blue-50 p-8 rounded-2xl">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Mindful AI Usage</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="md:w-1/2">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h4 className="font-bold mb-4 text-blue-600">Our AI Philosophy:</h4>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-green-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-8">Making a Difference Together</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">50%</div>
                <p className="text-gray-600">Less AI computational energy than typical productivity apps</p>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">100%</div>
                <p className="text-gray-600">Renewable energy powered infrastructure</p>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">🌱</div>
                <p className="text-gray-600">Sustainable habits encouraged through Mike's guidance</p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            <Image 
              ...
              className="w-6 h-6"
            />
            <span className="text-gray-600">© 2024 Teyra. Sustainable productivity for everyone.</span>
          </div>
